...
CAT_ICONS = {
    ...
    'Negocios':               'bi-briefcase-fill',
    'Financas':               'bi-cash-coin',
    'Importacao':             'bi-globe-americas',
    'Lideranca':              'bi-star-fill',
    'Desenvolvimento Pessoal':'bi-lightbulb-fill',
    'Varejo':                 'bi-bag-fill',
    'Saude e Gestao':         'bi-heart-pulse-fill',
    'Livros em Ingles':       'bi-globe2',
    'Classicos Brasileiros':  'bi-book-fill',
}
CAT_COLORS = {
    ...
    'Varejo':                 '#E91E63',
    'Saude e Gestao':         '#16A085',
    'Livros em Ingles':       '#2196F3',
    'Classicos Brasileiros':  '#4CAF50',
}
...
@login_required
def dashboard():
    return render_template_string(TMPLS['dashboard.html'])
